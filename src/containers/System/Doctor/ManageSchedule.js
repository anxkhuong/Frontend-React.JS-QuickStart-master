...
import {fetchAllScheduleTime} from "../../../store/actions";
...
this.setState({
    ...
    handleClickBtnTime = (time) =>{
        console.log('check item click', time)
    ...
    handleSaveSchedule = async () =>{
        ...
        // let formatedDated = moment(currentDate).unix();
...
if(selectedTime && selectedTime.length > 0){
    ...
    toast.error('invaled selected time! ');
    return;
}
       }
