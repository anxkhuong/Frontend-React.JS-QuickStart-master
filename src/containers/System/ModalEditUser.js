...
class ModalEditUser extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            input type = 'text'
            onChange = {
                (event) => { this.handleOnChangeInput(event, "email") }
            }
            ...
            input type = 'password'
            onChange = {
                (event) => { this.handleOnChangeInput(event, "password") }
            }
            ...
            input type = 'text'
            onChange = {
                (event) => { this.handleOnChangeInput(event, "address") }
            }
